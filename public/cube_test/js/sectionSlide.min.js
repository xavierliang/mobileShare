...
var app = function(a, b) {
    ...
    function g(a) {
        for (var b = 0; b < timeouts.length; b++) clearTimeout(this);
        switch (timeouts = [], a) {
          case "up":
            currentFragment >= 0 ? (console.log(currentFragment), currentFragment--, i()) : h(a);
            break;
    ...
    $cache = {
        ...
        fragments: b(".slide").eq(0).find(".fragment")
    }, c;
}(window.app || {}, jQuery);
